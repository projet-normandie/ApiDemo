...
use ProjetNormandie\DddProviderBundle\Layer\Application\Generalisation\Validation\ValidationHandler\{
    AbstractPatchManyCommandValidationHandler
};
...
/**
 * Class PatchManyCommandValidationHandler
 *
 ...
 * @license MIT
 */
class PatchManyCommandValidationHandler extends AbstractPatchManyCommandValidationHandler
{
    /**
     * Initializes the basics constraints validation for each property of the PatchMany command.
     *
