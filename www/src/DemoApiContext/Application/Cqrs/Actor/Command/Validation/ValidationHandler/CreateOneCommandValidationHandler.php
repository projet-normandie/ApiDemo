...
/**
 * Class CreateOneCommandValidationHandler
 *
 ...
 * @license MIT
 */
class CreateOneCommandValidationHandler extends AbstractCommandValidationHandler
{
    /**
     * Initializes the basics constraints validation for each property of the CreateOne command.
     *
