...
use ProjetNormandie\DddProviderBundle\Layer\Application\Generalisation\Validation\ValidationHandler\{
    AbstractUpdateManyCommandValidationHandler
};
...
/**
 * Class UpdateManyCommandValidationHandler
 *
 ...
 * @license MIT
 */
class UpdateManyCommandValidationHandler extends AbstractUpdateManyCommandValidationHandler
{
    /**
     * Initializes the basics constraints validation for each property of the UpdateMany command.
     *
