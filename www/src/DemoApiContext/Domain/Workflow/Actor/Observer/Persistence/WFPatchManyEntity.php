 ...
 * @license MIT
 */
class WFPatchManyEntity extends WFSaveEntity
{
    use TraitStdClass;

    /**
     * Sends a persist action update to specific patch manager for all entities.
     *
     * @uses WFPatchManyEntity::processToManager()
     ...
     * @used-by WFPatchManyEntity::update()
     * @return Actor
     * @throws Exception
     */
