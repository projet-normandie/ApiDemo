...
use DemoApiContext\Domain\Service\Actor\Manager\Command\UpdateManager;
 ...
 *
 * @coversDefaultClass UpdateManager
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
...
class UpdateManagerTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->updateManager = new UpdateManager($this->repositoryFactory, $this->fieldsDefinition);
        $this->updateManager->setLogger($this->logger);
    }

    /**
     * Tests UpdateManager process method.
     *
     * @covers ::process()
     */
    public function testUpdate(): void
    {
        ...
        $result = $this->updateManager->process($object);
    ...
    public function testUpdateException(): void
    {
        ...
        $this->updateManager->process($object);
    }
    ...
    private function initVOs(): void
    {
        ...
        $oMorphologicContactVO->email = 'johnny@good.fr';
