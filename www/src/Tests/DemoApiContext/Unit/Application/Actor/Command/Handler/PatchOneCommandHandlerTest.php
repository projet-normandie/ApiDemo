...
use DemoApiContext\Application\Cqrs\Actor\Command\Handler\PatchOneCommandHandler;
...
/**
 * Class PatchOneCommandHandlerTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Application
 * @subpackage Actor\Command\Handler
 *
 * @coversDefaultClass PatchOneCommandHandler
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class PatchOneCommandHandlerTest extends TestCase
{
    use TraitElementPointer;

    /**
     * @var Phake_IMock $command Mock instance of PatchOneCommand.
     * @see PatchOneCommand
     */
    private $command;
    ...
    /**
     * @var Phake_IMock $workflowHandler Mock instance of PatchOneWFHandler.
    ...
    {
        $this->workflowHandler = Phake::mock(PatchOneWFHandler::class);
        $this->command = Phake::mock(PatchOneCommand::class);
    ...
    public function testCommandHandlerProcessException(): void
    {
        ...
        $newCommandHandlerProcess = new PatchOneCommandHandler($this->workflowHandler);
