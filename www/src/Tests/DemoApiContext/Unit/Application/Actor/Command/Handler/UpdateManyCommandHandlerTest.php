...
use DemoApiContext\Application\Cqrs\Actor\Command\Handler\UpdateManyCommandHandler;
...
/**
 * Class UpdateManyCommandHandlerTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Application
 * @subpackage Actor\Command\Handler
 *
 * @coversDefaultClass UpdateManyCommandHandler
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class UpdateManyCommandHandlerTest extends TestCase
{
    use TraitElementPointer;

    /**
     * @var Phake_IMock $command Mock instance of UpdateManyCommand.
     * @see UpdateManyCommand
     */
    private $command;
    ...
    /**
     * @var Phake_IMock $workflowHandler Mock instance of UpdateManyWFHandler.
    ...
    {
        $this->workflowHandler = Phake::mock(UpdateManyWFHandler::class);
        $this->command = Phake::mock(UpdateManyCommand::class);
    ...
    public function testCommandHandlerProcessException(): void
    {
        ...
        $newCommandHandlerProcess = new UpdateManyCommandHandler($this->workflowHandler);
