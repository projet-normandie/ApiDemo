...
use DemoApiContext\Presentation\Coordination\Actor\Command\UpdateOneController;
use Phake;
use Phake_IMock;
...
/**
 * Class UpdateOneControllerTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Presentation
 * @subpackage Coordination\Actor\Command
 *
 * @coversDefaultClass UpdateOneController
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class UpdateOneControllerTest extends TestCase
{
    /**
    ...
    /** @var UpdateOneController $controller */
    ...
    public function setUp(): void
    {
        ...
        $this->controller = new UpdateOneController(
            $this->commandAdapter,
            $this->commandRequest,
            $this->commandHandler,
    ...
    {
        $updateOneCommand = Phake::mock(UpdateOneCommand::class);
        Phake::when($this->commandAdapter)
            ->buildCommandFromRequest(Phake::anyParameters())
            ->thenReturn($updateOneCommand);
