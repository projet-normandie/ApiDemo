...
use DemoApiContext\Presentation\Coordination\Actor\Command\PatchOneController;
use Phake;
use Phake_IMock;
...
/**
 * Class PatchOneControllerTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Presentation
 * @subpackage Coordination\Actor\Command
 *
 * @coversDefaultClass PatchOneController
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class PatchOneControllerTest extends TestCase
{
    /**
    ...
    /** @var PatchOneController $controller */
    ...
    public function setUp(): void
    {
        ...
        $this->controller = new PatchOneController(
            $this->commandAdapter,
            $this->commandRequest,
            $this->commandHandler,
