...
use DemoApiContext\Presentation\Coordination\Actor\Command\DeleteManyController;
use Phake;
use Phake_IMock;
...
/**
 * Class DeleteManyControllerTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Presentation
 * @subpackage Coordination\Actor\Command
 *
 * @coversDefaultClass DeleteManyController
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class DeleteManyControllerTest extends TestCase
{
    /**
    ...
    /** @var DeleteManyController $controller */
    ...
    public function setUp(): void
    {
        ...
        $this->controller = new DeleteManyController(
            $this->commandAdapter,
            $this->commandRequest,
            $this->commandHandler,
    ...
    {
        $deleteManyCommand = Phake::mock(DeleteManyCommand::class);
        Phake::when($this->commandAdapter)
            ->buildCommandFromRequest(Phake::anyParameters())
            ->thenReturn($deleteManyCommand);
