...
use DemoApiContext\Presentation\Coordination\Actor\Query\GetOneController;
use Phake;
use Phake_IMock;
...
/**
 * Class GetOneControllerTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Presentation
 * @subpackage Coordination\Actor\Query
 *
 * @coversDefaultClass GetOneController
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class GetOneControllerTest extends TestCase
{
    /**
    ...
    /** @var GetOneController $controller */
    ...
    public function setUp(): void
    {
        ...
        $this->controller = new GetOneController(
            $this->queryAdapter,
            $this->queryRequest,
            $this->queryHandler,
