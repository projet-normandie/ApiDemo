...
use DemoApiContext\Presentation\Coordination\Actor\Command\DeleteOneController;
use Phake;
use Phake_IMock;
...
/**
 * Class DeleteOneControllerTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Presentation
 * @subpackage Coordination\Actor\Command
 *
 * @coversDefaultClass DeleteOneController
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class DeleteOneControllerTest extends TestCase
{
    /**
    ...
    /** @var DeleteOneController $controller */
    ...
    public function setUp(): void
    {
        ...
        $this->controller = new DeleteOneController(
            $this->commandAdapter,
            $this->commandRequest,
            $this->commandHandler,
    ...
    {
        $deleteOneCommand = Phake::mock(DeleteOneCommand::class);
        Phake::when($this->commandAdapter)
            ->buildCommandFromRequest(Phake::anyParameters())
            ->thenReturn($deleteOneCommand);
