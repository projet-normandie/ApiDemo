...
/**
 * Class CreateOneRequestTest
 *
 * @category Tests\DemoApiContext\Unit
 * @package Presentation
 * @subpackage Request\Actor\Command
 *
 * @coversDefaultClass CreateOneRequest
 * @group unit
 * @requires PHP 7.0
 *
 * @license MIT
 */
class CreateOneRequestTest extends TestCase
{
     ...
     * Tests the request.
     *
     * @covers CreateOneRequest::process()
     */
    public function testRequest(): void
    {
        ...
        $request = new CreateOneRequest($this->request, $this->resolver);
    ...
    public function testExceptionBecauseInvalidJson(): void
    {
        ...
        new CreateOneRequest($this->request, $this->resolver);
    }
}
